describe("Blog app", function () {
  ...
  describe("Login", function () {
    it("succeeds with correct credentials", function () {
      ...
      cy.get("[data-cy=password-input]").type("mrbrown");
    ...
    it("fails with incorrect credentials", function () {
      cy.get("[data-cy=username-input]").type("wrongname");
  ...
  describe("When logged in", function () {
    ...
    it("a new blog can be created", function () {
      cy.get("[data-cy=newblog-button]").click();

      cy.get("[data-cy=newblog-titleinput]").type("blogtitlehere");

      cy.get("[data-cy=newblog-authorinput]").type("authorhere");

      cy.get("[data-cy=newblog-urlinput]").type("url.com/xyz");

      cy.get("[data-cy=newblog-save-button]").click();

      cy.get("[data-cy=blog-title-minimal]").contains("blogtitlehere");
    });
    ...
    describe("and blogs already exist", function () {
      ...
      it("an existing blog can be liked", function () {
        cy.get("[data-cy=blog-title-minimal]")
          .contains("A New Blog")
          .parent()
          .parent()
          .parent()
          .find("[data-cy=blog-details-link]")
          .click();

        cy.get("[data-cy=blog-likes-label]")
          .contains("0")
      ...
      it("the user can delete their own blogs", function () {
        ...
        cy.get("@blogs").should("have.length", 2);
      });
